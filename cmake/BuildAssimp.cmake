...
if(WIN32)
  ...
  set(ASSIMP_SHARE_LIB_INSTALL_LOCATION bin/${ASSIMP_SHARE_LIB_FULL_NAME})
  set(ASSIMP_ADDITIONAL_CMAKE_ARGS "")
elseif(APPLE)
  ...
  set(ASSIMP_SHARE_LIB_INSTALL_LOCATION lib/${ASSIMP_SHARE_LIB_FULL_NAME})
  set(ASSIMP_ADDITIONAL_CMAKE_ARGS
      -DCMAKE_OSX_ARCHITECTURES=${CMAKE_OSX_ARCHITECTURES} -DCMAKE_OSX_DEPLOYMENT_TARGET=${CMAKE_OSX_DEPLOYMENT_TARGET}
...
ExternalProject_Add(
  ...
  BUILD_BYPRODUCTS <INSTALL_DIR>/bin/${ASSIMP_SHARE_LIB_FULL_NAME} INSTALL_BYPRODUCTS
                   <INSTALL_DIR>/${ASSIMP_SHARE_LIB_INSTALL_LOCATION}
  CMAKE_ARGS -DCMAKE_INSTALL_PREFIX=<INSTALL_DIR>
             ...
             ${ASSIMP_ADDITIONAL_CMAKE_ARGS})

ExternalProject_Get_Property(assimp-build INSTALL_DIR)

add_library(assimp::assimp SHARED IMPORTED)
add_dependencies(assimp::assimp assimp-build)
set_target_properties(assimp::assimp PROPERTIES IMPORTED_LOCATION ${INSTALL_DIR}/${ASSIMP_SHARE_LIB_INSTALL_LOCATION})
if(WIN32)
...
if(WIN32)
  ...
  install(FILES ${INSTALL_DIR}/${ASSIMP_SHARE_LIB_INSTALL_LOCATION}
